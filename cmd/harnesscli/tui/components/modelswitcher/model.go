...
var DefaultModels = []ModelEntry{
	...
	// Anthropic
	{ID: "claude-fable-5", DisplayName: "Claude Fable 5", Provider: "anthropic", ProviderLabel: "Anthropic"},
	{ID: "claude-opus-5", DisplayName: "Claude Opus 5", Provider: "anthropic", ProviderLabel: "Anthropic"},
	{ID: "claude-opus-4-8", DisplayName: "Claude Opus 4.8", Provider: "anthropic", ProviderLabel: "Anthropic"},
	{ID: "claude-opus-4-7", DisplayName: "Claude Opus 4.7", Provider: "anthropic", ProviderLabel: "Anthropic"},
	{ID: "claude-opus-4-6", DisplayName: "Claude Opus 4.6", Provider: "anthropic", ProviderLabel: "Anthropic"},
	{ID: "claude-sonnet-5", DisplayName: "Claude Sonnet 5", Provider: "anthropic", ProviderLabel: "Anthropic"},
