...
- `2026-03-25-issue-427-http-feature-decomposition-plan.md`: Active plan for continuing the `internal/server/http.go` feature decomposition without changing API behavior.
