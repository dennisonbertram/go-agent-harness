...
- `2026-04-29-issue-556-git-diff-maxbytes-plan.md`: Active plan for fixing `TestGitDiffTool_MaxBytes` so it uses a controlled git diff fixture instead of ambient workspace changes.
