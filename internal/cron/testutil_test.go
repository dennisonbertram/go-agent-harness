...
func (m *mockStore) UpdateJobCAS(ctx context.Context, job Job, expectedUpdatedAt time.Time) error {
	if m.UpdateJobCASFunc != nil {
		return m.UpdateJobCASFunc(ctx, job, expectedUpdatedAt)
	}
	return m.UpdateJob(ctx, job)
}
