...
func VerifySkillTool(verifier tools.SkillVerifier) tools.Tool {
	return buildVerifySkillTool(verifier)
}

// buildVerifySkillTool is the internal constructor.
func buildVerifySkillTool(verifier tools.SkillVerifier) tools.Tool {
...
func runSkillVerification(ctx context.Context, verifier tools.SkillVerifier, name string) (string, error) {
...
// then parses the YAML frontmatter. Used by buildVerifySkillTool.
