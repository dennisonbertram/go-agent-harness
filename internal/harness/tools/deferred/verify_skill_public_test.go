// Tests for the verify_skill tool, moved here with its implementation when
// the duplicate tool package was consolidated away.
package deferred
...
// ---------- mock tools.SkillVerifier for flat tools package ----------
...
func (m *mockFlatSkillVerifier) GetSkill(name string) (tools.SkillInfo, bool) {
	s, ok := m.skills[name]
	return s, ok
}

func (m *mockFlatSkillVerifier) ListSkills() []tools.SkillInfo {
...
func TestVerifySkillToolPublic_NoFilePath(t *testing.T) {
	...
	verifier := &mockFlatSkillVerifier{
		skills:    map[string]tools.SkillInfo{"ghost": {Name: "ghost", Description: "no file", Source: "local"}},
...
func TestVerifySkillToolPublic_ShortBody(t *testing.T) {
	...
	verifier := &mockFlatSkillVerifier{
		skills:    map[string]tools.SkillInfo{name: {Name: name, Description: "short", Source: "local"}},
...
func TestVerifySkillToolPublic_InvalidFrontmatter(t *testing.T) {
	...
	verifier := &mockFlatSkillVerifier{
		skills:    map[string]tools.SkillInfo{name: {Name: name, Description: "bad", Source: "local"}},
...
func TestVerifySkillToolPublic_FileNotReadable(t *testing.T) {
	t.Parallel()
	verifier := &mockFlatSkillVerifier{
		skills:    map[string]tools.SkillInfo{"x": {Name: "x", Description: "d", Source: "local"}},
...
func TestVerifySkillToolPublic_MissingNameInFrontmatter(t *testing.T) {
	...
	verifier := &mockFlatSkillVerifier{
		skills:    map[string]tools.SkillInfo{name: {Name: name, Description: "d", Source: "local"}},
		bodies:    map[string]string{name: "body"},
		filePaths: map[string]string{name: path},
	}
	tool := VerifySkillTool(verifier)
